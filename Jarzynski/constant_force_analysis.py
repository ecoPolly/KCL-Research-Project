...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def dwell_analysis(self):
        ...
        ax_down.set_xlabel("Dwell time (folded) [s]", fontsize=4)
        ax_down.set_ylabel("Count", fontsize=4)
        ax_down.set_title("Folded State", fontsize=6)
        ax_down.tick_params(axis='both', labelsize=4)
        ...
        ax_up.set_xlabel("Dwell time (unfolded) [s]", fontsize=4)
        ax_up.set_ylabel("Count", fontsize=4)
        ax_up.set_title("Unfolded State", fontsize=6)
        ax_up.tick_params(axis='both', labelsize=4)
        ...
        self.label_dwell_fold_2.setText(f"{rate_fold:.4g} s⁻¹")
        self.label_dwell_unfold_2.setText(f"{rate_unfold:.4g} s⁻¹")
    ...
    def deconvolve_ux(self):
        ...
        self.label_mfpt_fold_2.setText(f"{rate_folding:.4g} s⁻¹")
        self.label_mfpt_unfold_2.setText(f"{rate_unfolding:.4g} s⁻¹")
    ...
    def hmm_analysis(self):
        ...
        self.label_hmm_fold_2.setText(f"{rate_folding:.4g} s⁻¹")
        self.label_hmm_unfold_2.setText(f"{rate_unfolding:.4g} s⁻¹")
